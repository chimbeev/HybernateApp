...
//Эта аннотация позволяет Java-объектам вашего класса быть связанными с БД.
@Entity
@Table (name = "users")
public class User {
    ...
    // Настройка "mappedBY" указывает на поле user класса Auto. Таким образом машины и пользователи связаны между с собой.
